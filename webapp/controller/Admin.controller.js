    ...
    return Controller.extend("com.applexus.finalproject.controller.Admin", {
                    ...
                    onRowSave: function (oEvent) {
                        ...
                        // CALL ODATA 
                            ...
                            success: function (oData) {
                                ...
                                //  Update item properly in model
                                item.Status = "R";
                                item.CalculatedFine = oData.CalculatedFine || 0;

                                //  Refresh JSON model correctly
                                var oItemsModel = oView.getModel("itemsModel");
                                oItemsModel.setData(oItemsModel.getData()); // trigger UI update

                                sap.m.MessageToast.show("Saved item " + item.ItemID);

                                const aItems = oItemsModel.getData();
                                ...
                                if (allDone) {
                                    ...
                                    let refund = Math.max(0, deposit - totalFine);
                                    ...
                                    oItemsModel.setProperty("/allReturned", true);
                                    oItemsModel.setProperty("/totalFine", totalFine);
                                    oItemsModel.setProperty("/refund", refund);
                                }
         ...
         // Inventory Management
                ...
                onSaveRow: function(oEvent) {
                        ...
                        //  Available Qty empty or invalid
                        ...
                        //   BOTH = 0 → allowed, show confirmation and save
                        ...
                        //  Only Total = 0 (Available is not 0)
                        if (iTotalQty === 0 && iAvailableQty !== 0) {
                            oTotalInput.setValueState("Error");
                        ...
                        //  Only Available = 0 (Total is not 0)
